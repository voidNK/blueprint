...
using Blueprint.Application.Features.Products.Commands.Delete;
...
using Blueprint.Web.Abstractions;
using Blueprint.Web.Areas.Catalog.Models;
using Blueprint.Web.Extensions;
...
namespace Blueprint.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
